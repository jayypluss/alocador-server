...
const fileira_caixas_1 = require("./fileira-caixas");
const objeto_3d_1 = require("./objeto-3d");
class ParedeCaixas extends objeto_3d_1.Objeto3D {
    ...
    adicionarCaixa(caixa, container, paredeIndex) {
        if (this.fileiras.length < 1) {
            if (this.cabeFileiraComCaixa(caixa)) {
                this.fileiras.push(new fileira_caixas_1.FileiraCaixas(0, this.container, 0, paredeIndex));
...
//# sourceMappingURL=parede-caixas.js.map